...
function buildReaderDOM(){
  ...
  ov.innerHTML = `
    ...
    <div class="ar-bottombar">
      <!-- LA BARRETTA DEI COMANDI, sopra il cursore e fuori dalla capsula.
           Prima stavano in cima allo schermo, cioe' nell'angolo piu' lontano
           dalla mano; poi dentro la capsula, in fondo a tutto. Qui sono a
           meta' strada: sotto il pollice ma sopra la navigazione, e in
           verticale si legge come una scaletta — cosa faccio, dove vado, dove
           sono. Fuori dalla capsula perche' in ritaglio la capsula sparisce, e
