...
// La vista a schermo intero vive in un file suo (vedi lightbox.js). Da qui si
// ri-espone com'era: chi la chiamava — main.js, gli onclick nell'HTML — non
...
export function currentGridList(){
...
// La cache dei ritagli, per chi la legge da fuori (la vista a schermo intero).
// Una funzione e non la variabile: il listener la RIASSEGNA ad ogni arrivo da
// Firestore, e chi si fosse tenuto il vecchio array leggerebbe per sempre la
// fotografia di un istante.
export function refsCache(){ return _refs; }
