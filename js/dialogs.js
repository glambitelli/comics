...
export const ICONE = {
  ...
  tag:       `<path d="M4 11.2V5.8A1.8 1.8 0 0 1 5.8 4h5.4a1.8 1.8 0 0 1 1.27.53l7 7a1.8 1.8 0 0 1 0 2.54l-5.4 5.4a1.8 1.8 0 0 1-2.54 0l-7-7A1.8 1.8 0 0 1 4 11.2Z" ${G}/><circle cx="8.2" cy="8.2" r="1.3" ${G}/>`,
  piu:       `<path d="M12 5.5v13M5.5 12h13" ${G}/>`,
